...
const copy = {
  ...
  en: {
    ...
    declined_title: 'Demo - quote declined',
    declined_body: 'In a real account, the provider gets notified and the quote status changes to "Declined".',
    declined_reset: 'Reset demo',
