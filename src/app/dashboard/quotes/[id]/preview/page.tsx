          ...
          <tbody>
            {oneTimeItems.map((item: any, i: number) => (
              <tr key={i} className="border-b border-gray-100">
                ...
                {showQuantity && <td className="py-3 text-center text-gray-700">{item.discount_percent === 100 ? '' : item.quantity}</td>}
                <td className="py-3 text-center text-gray-700">{item.discount_percent === 100 ? '' : formatCurrency(item.unit_price, currency)}</td>
