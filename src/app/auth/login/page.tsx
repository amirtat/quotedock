  ...
  return (
    <div className="min-h-screen bg-obsidian flex">
      ...
      <div className="hidden lg:flex lg:w-2/5 flex-col justify-between p-10">
        ...
        <div>
          <p className="text-white/20 text-xs font-medium uppercase tracking-widest mb-4">הצעות מחיר שנסגרות</p>
          <h2 className="text-white text-4xl font-bold leading-tight mb-6">
            מהרעיון<br />
            <span className="text-saffron">לחתימה</span><br />
            בדקות
          </h2>
          <p className="text-white/40 text-sm leading-relaxed max-w-xs">
            צור הצעות מחיר מקצועיות, שלח ללקוחות, קבל אישור דיגיטלי — הכל במקום אחד.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-paper">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-bold text-ink mb-1">כניסה לחשבון</h1>
          <p className="text-muted text-sm mb-7">ברוך הבא חזרה</p>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-muted text-xs">או</span>
            <div className="flex-1 h-px bg-border" />
          </div>
