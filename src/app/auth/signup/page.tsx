  ...
  return (
    <div className="min-h-screen bg-obsidian flex">
      ...
      <div className="hidden lg:flex lg:w-2/5 flex-col justify-between p-10">
        ...
        <div>
          <p className="text-white/20 text-xs font-medium uppercase tracking-widest mb-4">בחינם לגמרי</p>
          <h2 className="text-white text-4xl font-bold leading-tight mb-6">
            הצעה ראשונה<br />
            תוך <span className="text-saffron">3 דקות</span>
          </h2>
          <ul className="flex flex-col gap-3">
            {['הצעות מחיר בעברית', 'קישור שיתוף ללקוח', 'אישור דיגיטלי', 'ניהול לקוחות ושירותים'].map((item) => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-paper">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-bold text-ink mb-1">יצירת חשבון חינמי</h1>
          <p className="text-muted text-sm mb-7">בלי כרטיס אשראי, בלי מגבלת זמן</p>
